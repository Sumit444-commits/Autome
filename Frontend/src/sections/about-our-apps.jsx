...
export default function AboutOurApps() {
    const sectionData = [
        {
            ...
            description: "Generate comprehensive READMEs in seconds — minimal wait times and fully optimized for your repo.",
        ...
        },
        {
            ...
            description: "Modern, pixel-perfect documentation structure ready to be pushed to any GitHub project.",
        ...
        {
            title: "Zero-Config Analysis",
            description: "Simple setup with native support for MERN, Python, and all modern tech stacks.",
    ...
    return (
        <section className="flex flex-col items-center" id="about">
            <SectionTitle title="About our engine" description="A technical breakdown of our automation process — each file analyzed with precision, logic, and speed." />
