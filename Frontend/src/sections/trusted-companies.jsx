  ...
  return (
    <section className="flex flex-col items-center">
      <SectionTitle
        ...
        description="Built for engineers to automate professional documentation instantly."
      />
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col items-center md:items-start max-md:text-center">
          ...
          >
            ...
            <p className="flex items-center gap-1">
              <span>Integrated into your workflow.</span>
              <svg
          ...
          <p className="text-base text-slate-400 max-w-lg mt-4">
           Autome connects with GitHub to analyze your repositories and generate high-quality READMEs that sync with your repo.
          </p>
        ...
        <div className="md:-mr-16 max-md:mt-10">
          <img className="max-w-xs md:max-w-md" src="/trust.png" alt="" />
        </div>
      </motion.div>
    </section>
  );
