    ...
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            >
                ...
                <span>Ready for your next repo</span>
            </motion.a>
            ...
            >
                Let's automate Your doc together
            </motion.h1>
            <motion.p className="text-center text-base max-w-[600px] mt-2"
                initial={{ y: 50, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Instantly turn any GitHub link into professional documentation. Focus on your code while Autome handles the presentation.
            </motion.p>
